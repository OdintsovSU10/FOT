    ...
    <div className={styles.content}>
      ...
      <div className={styles.contentGrid}>
        ...
        <div className={styles.rightColumn}>
          <button className={styles.timesheetBtn} onClick={() => navigate('/employee/timesheet')}>
            <div className={styles.timesheetBtnIcon}>
            ...
            <div className={styles.timesheetBtnText}>
              <div className={styles.timesheetBtnTitle}>Мой табель</div>
              <div className={styles.timesheetBtnDesc}>Учёт рабочего времени за текущий месяц</div>
            </div>
            <svg className={styles.timesheetBtnChevron} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
