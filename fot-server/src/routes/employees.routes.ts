...
router.get(
  '/:id/history',
  requireAnyPageAccess(['/employee/history', '/my-employees', '/tender', '/staff-control'], 'view'),
...
router.get(
  '/:id',
  requireAnyPageAccess(['/employee', '/my-employees', '/tender', '/staff-control'], 'view'),
